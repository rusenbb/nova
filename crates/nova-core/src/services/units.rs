...
static UNIT_ALIASES: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    ...
    m.insert("km\u{b2}", "square_kilometer");
    m.insert("sqmi", "square_mile");
    m.insert("mi2", "square_mile");
    m.insert("mi\u{b2}", "square_mile");
    m.insert("acre", "acre");
    m.insert("acres", "acre");
    m.insert("ha", "hectare");
...
static UNIT_DISPLAY: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    ...
    m.insert("celsius", "\u{b0}C");
    m.insert("fahrenheit", "\u{b0}F");
    m.insert("kelvin", "K");

    m.insert("square_meter", "m\u{b2}");
    m.insert("square_foot", "ft\u{b2}");
    m.insert("square_kilometer", "km\u{b2}");
    m.insert("square_mile", "mi\u{b2}");
    m.insert("acre", "acre");
    m.insert("hectare", "ha");
...
static UNIT_CATEGORIES: Lazy<HashMap<&'static str, Category>> = Lazy::new(|| {
    ...
    for u in ["meter", "kilometer", "centimeter", "millimeter", "mile", "yard", "foot", "inch", "nautical_mile"] {
        m.insert(u, Category::Length);
    }

    for u in ["kilogram", "gram", "milligram", "pound", "ounce", "metric_ton", "stone"] {
        m.insert(u, Category::Weight);
    }

    for u in ["liter", "milliliter", "gallon", "quart", "pint", "cup", "fluid_ounce", "tablespoon", "teaspoon"] {
    ...
    for u in ["square_meter", "square_foot", "square_kilometer", "square_mile", "acre", "hectare"] {
        m.insert(u, Category::Area);
    }

    for u in ["miles_per_hour", "kilometers_per_hour", "meters_per_second", "knot"] {
    ...
    for u in ["byte", "kilobyte", "megabyte", "gigabyte", "terabyte", "kibibyte", "mebibyte", "gibibyte", "tebibyte"] {
...
static CONVERSION_FACTORS: Lazy<HashMap<&'static str, f64>> = Lazy::new(|| {
    ...
    m.insert("month", 2_629_746.0);
    m.insert("year", 31_556_952.0);
